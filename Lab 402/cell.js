...
class Cell {
  ...
  render(){
    ...
    if(this.path){
      this.game.context.fillRect(this.loc.x + (this.game.cellDim/3), this.loc.y + (this.game.cellDim/3), 6, 6);
      this.game.context.strokeRect(this.loc.x + (this.game.cellDim/3), this.loc.y + (this.game.cellDim/3), 6, 6);
      this.game.contect.fillStyle = "blue";
    }
  }
